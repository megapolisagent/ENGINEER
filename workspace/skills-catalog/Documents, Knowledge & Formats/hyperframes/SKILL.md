...
>
> **Пробел донора**: тело ссылается на `references/{creator-editing-recipes,intent-interview,media-treatments,skill-lifecycle}.md` и `references/routes/remotion-to-hyperframes.md` — ни один не перенесён вместе с этим entry-point файлом (см. пояснение выше про ~19 неперене­сённых сопутствующих скиллов).

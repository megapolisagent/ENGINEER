---
name: tldraw-offline
description: Use when the user wants an agent to read or edit an open tldraw offline canvas, or write document scripts (JS embedded in .tldraw files) for durable reactive shapes, buttons, or animations.
license: MIT
---

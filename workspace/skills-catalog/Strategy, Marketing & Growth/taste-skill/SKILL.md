---
name: taste-skill
description: Use when building or redesigning a landing page, portfolio, or marketing site and the result must not look templated (anti-slop) — infers design direction from the brief, picks a real design system where one applies, audits before touching an existing redesign.
---
...
Full rules (typography, color, layout, materiality, states, forms, layout discipline, image strategy, content density, quotes, theme lock) — read before generating any markup: [references/design-engineering-directives.md](references/design-engineering-directives.md).
...
Canonical skeleton implementations (Sticky-Stack, Horizontal-Pan, Scroll-Reveal Stagger): [examples/canonical-skeletons.md](examples/canonical-skeletons.md).
...
Full forbidden-pattern checklist (visual/CSS, typography, layout/spacing, content/data, external resources, production-test tells, em-dash ban): [references/ai-tells.md](references/ai-tells.md). Check output against it before finishing.

## 10. REFERENCE VOCABULARY (Pattern Names the Agent Should Know)

Named patterns for hero paradigms, navigation, layout/grids, cards, scroll animations, galleries, typography, micro-interactions, and animation libraries: [references/reference-vocabulary.md](references/reference-vocabulary.md).
...
Real source-backed reference material — install commands per design system, canonical doc links, and an honest Apple Liquid Glass web approximation: [references/appendices.md](references/appendices.md).
